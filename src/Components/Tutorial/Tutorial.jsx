...
const SignLanguageTutorial = () => {
  ...
  const getSignMedia = (letter, emoji) => {
    ...
    const mediaMap = {
     ...
     'Thank You': '/public/gifs/thanku.gif',
     'Good Morning':'/public/gifs/gdmorning.gif',
     'Good Afternoon':'/public/gifs/gdafternoon.gif',
     'Good Night':'/public/gifs/gdnight.gif',
      'Please': '/gifs/please.gif',
      'Sorry': '/gifs/sorry.gif',
      'Help': '/public/gifs/help.gif',
      'Family': '/public/gifs/family.gif',
      'Mother': '/public/gifs/mother.gif',
      'Father': '/public/gifs/father.gif',
      'Sister':'/public/gifs/sister.gif',
      'Brother':'/public/gifs/brother.gif',
      'Daughter':'/public/gifs/daughter.gif',
      'Son':'/public/gifs/son.gif',
      'Grandmother':'/public/gifs/grandma.gif',
      'Grandfather':'/public/gifs/grandpa.gif',
      'Aunt':'/public/gifs/aunt.gif',
      'Uncle':'/public/gifs/uncle.gif',
      'Cousin':'/public/gifs/cousin.gif',
      'Friend':'/public/gifs/friend.gif',
      'Husband':'/public/gifs/husband.gif',
      'Wife':'/public/gifs/wife.gif',
      'Happy': '/public/gifs/happy.gif',
      'Sad': '/public/gifs/sad.gif',
      'Angry':'/public/gifs/angry.gif',
      'Excited':'/public/gifs/excited.gif',
      'Love': '/public/gifs/love.gif',
      'Doctor':'/public/gifs/doctor.gif',
      'Hospital':'/public/gifs/hospital.gif',
      'Hurt':'/public/gifs/hurt.gif',
      'Sick':'/public/gifs/sick.gif',
      'Who':'/public/gifs/who.gif',
    };
